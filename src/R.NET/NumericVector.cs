...
namespace RDotNet
{
    ...
    public class NumericVector : Vector<double>
    {
        ...
        {
            return GetFunction<REAL_ELT>()(DangerousGetHandle(), (IntPtr)index);
        }
        ...
        {
            GetFunction<SET_REAL_ELT>()(DangerousGetHandle(), (IntPtr)index, value);
        }
        ...
        public override double[] GetAltRepArray()
        {
            ...
            var res = new double[Length];
            GetFunction<REAL_GET_REGION>()(DangerousGetHandle(), (IntPtr)0, (IntPtr)Length, res);
            return res;
        }
